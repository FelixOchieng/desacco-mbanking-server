 ...
 **/
public class HashAgencyPINsProcessor implements Runnable {

    private final String CBS_SERVICE_NAME;
    private final int CBS_SERVICE;

    public HashAgencyPINsProcessor() {
        this.CBS_SERVICE_NAME = "HashAgencyPINsProcessor";
        this.CBS_SERVICE = 0; //HASH AGENCY PINS
    }

    public static void start(long startDelay, long intervalPeriod) {
        ScheduledExecutorService executorService = new ScheduledThreadPoolExecutor(1);

        executorService.scheduleAtFixedRate(new HashAgencyPINsProcessor(),
