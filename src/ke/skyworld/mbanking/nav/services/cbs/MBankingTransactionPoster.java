 ...
 **/
public class MBankingTransactionPoster implements Runnable {

    private final String CBS_SERVICE_NAME;
    private final int CBS_SERVICE;

    public MBankingTransactionPoster() {
        this.CBS_SERVICE_NAME = "MBankingTransactionPoster";
        this.CBS_SERVICE = 1; //POST MBANKING TRANSACTIONS
    }

    public static void start(long startDelay, long intervalPeriod) {
        ScheduledExecutorService executorService = new ScheduledThreadPoolExecutor(1);

        executorService.scheduleAtFixedRate(new MBankingTransactionPoster(),
