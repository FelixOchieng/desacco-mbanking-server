 ...
 **/
public class MemberEmailsProcessor implements Runnable {

    private final String CBS_SERVICE_NAME;
    private final int CBS_SERVICE;

    public MemberEmailsProcessor() {
        this.CBS_SERVICE_NAME = "MemberEmailsProcessor";
        this.CBS_SERVICE = 3; //SEND MEMBER EMAIL
    }

    public static void start(long startDelay, long intervalPeriod) {
        ScheduledExecutorService executorService = new ScheduledThreadPoolExecutor(1);

        executorService.scheduleAtFixedRate(new MemberEmailsProcessor(),
