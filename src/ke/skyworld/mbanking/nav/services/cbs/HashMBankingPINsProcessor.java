 ...
 **/
public class HashMBankingPINsProcessor implements Runnable {

    private final String CBS_SERVICE_NAME;
    private final int CBS_SERVICE;

    public HashMBankingPINsProcessor() {
        this.CBS_SERVICE_NAME = "HashMBankingPINsProcessor";
        this.CBS_SERVICE = 0; //HASH MBANKING PINS
    }

    public static void start(long startDelay, long intervalPeriod) {
        ScheduledExecutorService executorService = new ScheduledThreadPoolExecutor(1);

        executorService.scheduleAtFixedRate(new HashMBankingPINsProcessor(),
