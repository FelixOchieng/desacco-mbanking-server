...
public class Navision {
    ...
    public static BasicCredentialsProvider getCredentialsProvider(){
        try {
            String strURL = Navision.params.getCoreBankingUrl();
            ...
            credentialsProvider.setCredentials(
                    ...
                    new NTCredentials(
                            Navision.params.getCoreBankingUsername(),
                            Navision.params.getCoreBankingPassword().toCharArray(),
                            Navision.params.getCoreBankingWorkstation(),
                            Navision.params.getCoreBankingDomain()
                    ));
